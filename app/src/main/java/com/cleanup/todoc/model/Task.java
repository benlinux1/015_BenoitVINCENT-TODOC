...
public class Task {
     ...
     */
    @PrimaryKey(autoGenerate = true) // used to give PK attribute to id column in this TASK table
    private long id;
    ...
    /**
     * Add new constructor with @ignore annotation to avoid build error "Missing setter for id" (because ID is autogenerated in database)
     * @param projectId         the unique identifier of the project associated to the task to set
     * @param name              the name of the task to set
     * @param creationTimestamp the timestamp when the task has been created to set
     */
    ...
    /**
     * Returns the id of the task's project.
     *
     * @return the name of the task's project
     */
    @NonNull
     ...
     *
     * @return the the timestamp when the task has been created
     */
    @NonNull
